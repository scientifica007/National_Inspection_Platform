...
- `INCREMENT_GATE_TEMPLATE.md` — mandatory gate template for every increment.
- `SLICE_01_INCREMENT_PLAN.md` — increments S01-I01 … S01-I07.
- `TEST_STRATEGY.md` — automated and human test layers.
- `REVIEW_AND_CHANGE_POLICY.md` — branch/review/correction/change-control policy.
...
- `AI_EXECUTOR_PROMPT_01.md` — ready-to-use executor prompt.
...
- `DECISION_REGISTER.md` — summarized accepted/open decisions.
...
Implementation truth requires code + tests + passed increment gate.
